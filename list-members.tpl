<div class="ia-item">
    <div class="ia-item__image">
        {ia_image file=$listing.avatar type='thumbnail' title=$listing.fullname|default:$listing.username class='img-circle' gravatar=true email=$listing.email width=200}
    </div>
